...
### Быстрая установка (рекомендуется для разработки)

Одной командой собрать и установить расширение в Codium:
...
1. Соберёт расширение (`.vsix` файл)
2. Установит его в Codium
3. Готова к использованию после перезапуска редактора
